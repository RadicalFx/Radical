namespace Topics.Radical.Model
{
    ...
    //where T : class
    {
        ...
        /// </summary>
        /// <param name="e">The <see cref="Topics.Radical.Model.RebuildIndexesEventArgs"/> instance containing the event data.</param>
        ...
        protected virtual void OnRemovedAt( RebuildIndexesEventArgs e )
        {
             ...
             * (Topics.Data) farebbe il rebuild degli indici ma 
        ...
        /// </summary>
        /// <param name="e">The <see cref="Topics.Radical.Model.AddingNewEventArgs&lt;T&gt;"/> instance containing the event data.</param>
        ...
        protected virtual void OnEndNewCompleted( RebuildIndexesEventArgs e )
        {
             ...
             * di default la EntityView (Topics.Radical.Model) farebbe

...
#pragma warning disable 1591
    ...
    public static class NativeMethods
    {
        ...
        ////[DllImport( "User32.dll" )]
        ////internal static extern int SetWindowsHookEx( int idHook, Win32.Hooks.KeyboardHookDelegate lpfn, int hMode, int dwThreadId );
        ...
        //[DllImport( "User32.dll" )]
        //internal static extern int CallNextHookEx( IntPtr hhk, int nCode, int wParam, int lParam );

        ////[DllImport( "shell32.dll" )]
        ////internal static extern bool Shell_NotifyIcon( uint dwMessage, [In] ref NOTIFYICONDATA pnid );

        //[DllImport( "user32.dll", CharSet = CharSet.Auto, ExactSpelling = true )]
        //internal static extern bool TrackPopupMenuEx( HandleRef hmenu, int fuFlags, int x, int y, HandleRef hwnd, IntPtr tpm );

        //[DllImport( "User32.Dll" )]
        //internal static extern System.int GetCursorPos( ref POINT point );

...
namespace Radical.Model
{
        ...
        IServiceProvider
    {
        ...
        void OnDataSourceCollectionChanged(object sender, CollectionChangedEventArgs<T> e)
        {
            ...
            switch (e.ChangeType)
            {
                ...
                case CollectionChangeType.ItemChanged:
                    ...
                    if (newIndex > -1)
                    {
                        if (newIndex != oldIndex)
                        {
                             ...
                             * significa che la posizione dell'elemento � cambiata a seguito
                             * della modifica che ha subito, molto presumibilmente questo �
                             * dovuto al fatto che la View � sortata quindi informiamo dello
                             * spostamento
                             */
                    ...
                    {
                        /*
                         * L'introduzione di ItemRemoved non dovrebbe pi� portare qui...
                         */
                ...
                case CollectionChangeType.ItemRemoved:
                     ...
                     * video.
                     * 
                     * Questa informazione non c'�... perch� a questo punto l'elemento
                     * � gi� stato rimosso e l'Indexer non � in grado di dirci dove stava.
                     * 
                     * L'unica soluzione che mi viene in mente � che l'Indexer abbia un indice
                     * che tiene traccia degli indici: Dictionary<int, int> con 
                     * SourceIndex --> ViewIndex
                     * 
                     * Un'altra possibile soluzione � che tra gli arguments ci sia anche un riferimento
                     * all'elemento rimosso, in questo modo lo potremmo cercare nella View, perderemmo in
                     * performance ma sarebbe pi� semplice
                     */
        ...
        //{
        //    /*
        //     * Questo � l'elemento che � stato cancellato
        //     */
        //    T item = ( T )sender;

        //    /*
        //     * Ci assicuriamo che il contesto sia quello giusto,
        //     * non vedo perch� non dovrebbe ma un controllo in pi�
        //     * non fa male... :-)
        //     */
        ...
        //{
        //    /*
        //     * Questo � l'elemento che � stato salvato
        //     */
        //    T item = ( T )sender;
        ...
        void OnEntityItemViewPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (index > -1)
            {
                 ...
                 * modifica sia presente nella View, potrebbe non esserci perch� in quel 
                 * momento la View � filtrata. In realt� non � vero perch� se � filtrata non
        ...
        void OnEntityItemViewEditEnded(object sender, EventArgs e)
        {
             ...
             * 
             * Se la View � filtrata o sortata in qualche modo collection'� la possibilit� che
             ...
             * un esempio classico � la classica Person con una propriet� Name, se la View
             * � sortata e cambio il Name la posizione dell'istanza all'interno della view
             ...
             * non � detto che questa debba restare tra quelle visibili.
             * 
             * Anche se tutto ci� concettualmente � giusto resta il problema che la variazione 
             * di visibilit� o posizione potrebbe essere "mal digerita" dall'utente diamo quindi
             * la possibilit� alla classe derivata di decidere se riapplicare filtro e sort a seguito
             * di una modifica ad un elemento.
             * 
             * Il comportamento �: riapplicare sempre.
             */
            IEntityItemView<T> item = (IEntityItemView<T>)sender;

            /*
             * Dobbiamo sapere se l'elemento � visibile 
             ...
             * all'eventuale classe derivata che avr� la possibilit� di
             * bloccare il Rebuild
             */
             ...
             * se il valore � -1 significa che � stato escluso dal 
             * filtro corrente, adesso siamo obbligati ad usare EntityItem
             * perch� se gli Indici sono stati ricreati l'istanza (sender)
             * che abbiamo di IEntityItemView non esister� di certo pi�
             */
        ...
        public void Move(int sourceIndex, int newIndex)
        {
             ...
             * che � sortato perch� dato che dopo la Move gli indici 
            ...
            /*
             * Se la view non � sorted/filterd gli indici coincidono
             * con quelli della data source altrimenti no, quindi in
             * tutti i casi la prima operazione � quella di recuperare
            ...
            {
                /*
                 * Se � una IEntityCollection<T> usiamo Move cos� l'eventuale
        ...
        public IEntityItemViewFilter<T> Filter
        {
            get
            {
                ...
                {
                    /*
                     * Se il filtro � null impostiamo un bel "ViewAll"
                     */
        ...
        public void ApplySort(ListSortDescriptionCollection sorts)
        {
             ...
             * non va pi� bene, lo impostiamo a null in questo modo quando l'Indexer 
        ...
        public void ApplySort(string sort)
        {
            ...
            else
            {
                ...
                {
                    /*
                     * Estrae la propriet� per cui sortare, 
                    ...
                    /*
                     * Cerchiamo di ricavre la propriet� che 
        ...
        bool IList.Contains(object value)
        {
             ...
             * L'inghippo � questo, da verificare se con la DataView non si verifica.
             ...
             * funziona solo dalla listview verso il vm e non viceversa, la cosa � evidente
             * perch� non potendo aggiungere alla view degli elementi selezionati
             * direttamente un EntityItemView l'unica cosa che possiamo fare � agire
             ...
             * mano un'istanza dell'entityitemview ci chiede se lo conteniamo, � evidente
             * che la risposta � no perch� quell'elemento sta nella lista dei selezionati
             * e non nella lista degli itemsSource della lista, quello che invece � shared
             * � la data source. In effetti, se spulciamo con reflector, sembra che la dataView
        ...
        protected virtual void OnRemovedAt(RebuildIndexesEventArgs e)
        {
             ...
             * il rebuild viene gi� fatto a seguito degli eventi scatenati
        ...
        {
            /*
             * L'indice (index) che arriva � l'indice
            ...
            if (sourceIndex > -1)
            {
                 ...
                 * perch� il meccanismo � implicito, in caso contrario
                 * dobbiamo pensarci noi alla ricostruzione dell'indice
                 * l'unica possibilit� che abbiamo � quella di chiedere
                 */
            ...
            {
                /*
                 * Se il sourceIndex � -1 significa
                 * che l'elemento � nuovo... quindi ci
        ...
        protected virtual PropertyDescriptorCollection OnGetItemProperties(PropertyDescriptor[] listAccessors)
        {
            if (listAccessors == null || listAccessors.Length == 0)
            {
                ...
                if (AutoGenerateProperties)
                {
                     ...
                     * nel pi� tradizionale dei metodi analizzando via reflection
                     * il tipo T e recuperando tutte le propriet� che non hanno un
                    ...
                    /*
                     * aggiungiamo i descriptor cos� trovati alla lista di quelli che
                ...
                {
                    /*
                     * Se ci sono delle propriet� custom le aggiungiamo
                     * alla lista delle propriet� da ritornare, in questo
                     * modo se AutoGenerateProperties � true le propriet�
        ...
        protected virtual void OnAddingNew(AddingNewEventArgs<T> e)
        {
            ...
            if (!e.Cancel)
            {
                ...
                {
                    /*
                     * il comportamento di default � che se NewItem � null
        ...
        IEntityItemView<T> OnAddNewCompleted(AddingNewEventArgs<T> args)
        {
            if (!args.Cancel)
            {
                 ...
                 * perch� o � stato creato nel gestore dell'evento
                 * o ci � stato dato da EntityCollection<T> quindi se
                 * non c'� l'exception � sacrosanta!
                 */
                if (item == null)
                {
        ...
        protected virtual void OnEndNewCompleted(RebuildIndexesEventArgs e)
        {
             ...
             * gi� fatto a seguito degli eventi scatenati dalla
             * DataSource, chiediamo quindi alla IEntityView di non
             * fare il rebuild se la DataSource � di tipo IEntityCollection
             */
            e.Cancel = DataSource is IEntityCollection<T>;
        }
        ...
        public void EndNew(int itemIndex)
        {
                ...
                PendingNewItem != null && Indexer[itemIndex] == PendingNewItem)
            {
                 ...
                 * degli elementi pending (pu� succedere che questo metodo venga 
                 * richiamato pi� volte).
                 * 
                 * Sganciamo il gestore degli eventi per l'oggetto pending
                 * 
                 * E' importante notare che nelle implementazioni attuali
                 * della DataGrid e del DataGridView itemIndex corrisponder�
                 * _sempre_ all'indice dell'ultimo elemento semplicemente perch�
                 * i 2 controlli non consentono di avere pi� elementi 
                ...
                try
                {
                     ...
                     * 
                     * sta minchia!!! perch� qui non avviene proprio un bel nulla...
                     * la collection sottostante non ci notifica proprio un cazzo...
                     * 
                     * Il problema � che la DataSource qui non sappiamo cosa sia
                     * quindi non possiamo affidarci al suo motore di notifica
                     * per sapere che un nuovo elemento � stato aggiunto e quindi
                ...
                finally
                {
                    ...
                    /*
                     * Probabilmente in caso di Exception sarebbe pi� sensato
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (!isDisposed)
            {
                ...
                {
                    /*
                     * Se disposing � 'true' significa che dispose
                     * � stato invocato direttamentente dall'utente
                     * � quindi lecito accedere ai 'field' e ad 
                     * eventuali reference perch� sicuramente Finalize
                     * non � ancora stato chiamato su questi oggetti
                     */
                    lock (syncRoot)
                    {

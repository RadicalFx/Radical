namespace Radical.ComponentModel
{
    ...
    public class Timestamp<T> : Timestamp
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from the underlying type to <see cref="Radical.ComponentModel.Timestamp&lt;T&gt;"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Radical.ComponentModel.Timestamp&lt;T&gt;"/> 
